...
const fileName = process.argv[3] || 'WDPT-R1-2018-Syllabus.md'
...
for (let i = 1; i <= 24; i++) {
  ...
  for (let j = 1; j <= 3; j++) {
    ...
    row += `[](./${unit}/w${week}d${j}/morning_exercise)| [](./${unit}/w${week}d0${j}/instructor_notes)| [](./${unit}/w${week}d0${j}/student_labs)|[](./${unit}/w${week}d0${j}/homework)|`
    row += '\n'
